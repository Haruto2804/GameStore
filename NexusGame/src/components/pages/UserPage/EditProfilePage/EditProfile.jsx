      ...
      <div className="bg-bg-base max-w-6xl text-white mx-auto p-4">
        ...
        <div className="flex flex-col md:flex-row self-start items-center justify-between gap-4">
          ...
          <div className="flex gap-4 self-start">
            ...
            className="px-6 py-2.5 rounded-lg bg-primary cursor-pointer bg-green-500 hover:brightness-110 transition-all text-sm  shadow-[0_0_20px_rgba(13,242,89,0.3)]">Lưu thay đổi</button>
          </div>
        </div>
